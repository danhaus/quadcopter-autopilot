...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/pi/propelled_cow/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/pi/propelled_cow/devel)
  ...
  set(libmavconn_INSTALL_PREFIX /home/pi/propelled_cow/install)
...
if(NOT "/home/pi/propelled_cow/src/mavros/libmavconn/include;/usr/include;/opt/ros/kinetic/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/propelled_cow/src/mavros/libmavconn/include;/usr/include;/opt/ros/kinetic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/propelled_cow/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
