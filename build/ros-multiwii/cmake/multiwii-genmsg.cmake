...
set(MSG_I_FLAGS "-Imultiwii:/home/pi/propelled_cow/src/ros-multiwii/msg")
...
get_filename_component(_filename "/home/pi/propelled_cow/src/ros-multiwii/msg/MSPRawMessage.msg" NAME_WE)
add_custom_target(_multiwii_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "multiwii" "/home/pi/propelled_cow/src/ros-multiwii/msg/MSPRawMessage.msg" ""
)

get_filename_component(_filename "/home/pi/propelled_cow/src/ros-multiwii/srv/SendMSPRawMessage.srv" NAME_WE)
add_custom_target(_multiwii_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "multiwii" "/home/pi/propelled_cow/src/ros-multiwii/srv/SendMSPRawMessage.srv" "multiwii/MSPRawMessage"
)

get_filename_component(_filename "/home/pi/propelled_cow/src/ros-multiwii/srv/ReceiveMSPRawMessage.srv" NAME_WE)
add_custom_target(_multiwii_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "multiwii" "/home/pi/propelled_cow/src/ros-multiwii/srv/ReceiveMSPRawMessage.srv" "multiwii/MSPRawMessage"
)
...
_generate_msg_cpp(multiwii
  "/home/pi/propelled_cow/src/ros-multiwii/msg/MSPRawMessage.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/multiwii)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/multiwii\")")
  # install generated code
  install(
